...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mc.adg007.kdns.fr';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiYzdmYTM2Y2EtMjc5Yy00NjQxLTliYTAtYjcxNjQyYmNmYjM5IiwicyI6IlpHUTFaVEJqTWpJdE5EYzBNaTAwTVRNMExUbGpNMkV0TldGaVpUTXdaR1kwTWpkaSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id

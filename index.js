...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ssh.adg007.kdns.fr';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjllZmFhZDk2NmQyOTUwMDk5YzVjYjcyOTk5NGRkOWYiLCJ0IjoiZWExNTBjZjctMjcxZi00ODVmLTgyODgtYTE3ZjgyMzY2ODI4IiwicyI6IllUYzFZbUZoWWpNdFptVmhaQzAwTldaaExUbGtaRFV0TXpKaU5HSmtNVE15Wm1VMyJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
